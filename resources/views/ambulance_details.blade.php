            ...
            <div class="col-md-6 col-10 col-sm-6 col-lg-4 ">
                <div class="card border-0 mb-4" style="background: #ffffff;box-shadow:0px 0px 7px 2px #c1c1c1;">
                    <div class="img card-img-top m-auto mt-2 w-50 overflow-hidden d-flex justify-content-center border border-2">
                        <img src="{{asset($item->image ? $item->image:'/frontend/img/ambulance.png' )}}" style="width: 100%; height:160px;">
                    </div>
                    <div class="card-body">
                    ...
                    <a href="{{route('singlepageambulance', $item->id)}}" target="_blank" class="text-uppercase text-white text-decoration-none text-center">
    ...
    $(document).ready(() => {
        ...
        function Row(index, value) {
            ...
            <div class="col-md-6 col-10 col-sm-6 col-lg-4 ">
                <div class="card border-0 mb-4" style="background: #ffffff;box-shadow:0px 0px 7px 2px #c1c1c1;">
                    <div class="img card-img-top m-auto mt-2 w-50 overflow-hidden d-flex justify-content-center border border-2">
                        <img src="${value.image != 0? location.origin+'/'+value.image:location.origin+'/frontend/img/ambulance.png'}" style="width: 100%; height:160px;">
                    </div>
                    <div class="card-body">
